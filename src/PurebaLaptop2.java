...
public class PurebaLaptop2 extends UnicastRemoteObject implements ImageProcessor {

    protected PurebaLaptop2() throws RemoteException {
        super();
    }
    ...
    public static void main(String[] args) {
        try {
            ...
            System.err.println("ImageProcessorImpl2 exception:");
            e.printStackTrace();
        }
    }
}
